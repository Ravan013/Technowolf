...
namespace Online_Shopping_Backup
{
    public partial class add_admin : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into login_data values(@name,@password,@role,@address,@mobile_no,@email,@fname,@answer)", conn);
            ...
            cmd.Parameters.AddWithValue("@answer",txt_name.Text);
            conn.Open();
            cmd.ExecuteNonQuery();
