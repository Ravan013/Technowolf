        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox cssclass="form-control" ID="txt_fname" runat="server" placeholder="Enter Fullname" OnTextChanged="txt_fname_TextChanged"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" TextMode="SingleLine" ControlToValidate="txt_name" ErrorMessage="Please enter the Full name"></asp:RequiredFieldValidator>

                </div>
                <div class="form-group">
                    <label>Name</label>
                    <asp:TextBox CssClass="form-control" ID="txt_name" runat="server" placeholder="Enter Username" MaxLength="100">Please enter a username</asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_password" CssClass="form-control" runat="server" TextMode="Password" text="Enter Password"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_Email_address" runat="server" placeholder="Enter Email Address" TextMode="SingleLine" CssClass="form-control"></asp:TextBox>
                ...
                <asp:Button CssClass="btn btn-info" ID="btn_submit" runat="server" Text="Submit" OnClick="btn_submit_Click" lblmessage="Successful!"/>
            </div>
            <div class="col-lg-5">
            </div>
        </div>
